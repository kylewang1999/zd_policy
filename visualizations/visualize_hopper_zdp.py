...
def main():
    ...
    params = policy.init(split, 0, jnp.zeros((10,)))
    ...
    eta_d = jax.vmap(lambda z_: policy.apply(params, z_, method='psi'))(zs)
    plt.figure()
    ax = plt.subplot(121)
    ...
    eta_d = jax.vmap(lambda z_: policy.apply(params, z_, method='psi'))(input)
